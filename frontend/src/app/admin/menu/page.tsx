    ...
    <div className="overflow-y-auto max-h-[80vh]">
      <div className="p-5 space-y-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div><label className="text-xs font-medium text-stone-500 mb-1 block">Price (KES) *</label><input className="input" type="number" min="0" step="50" value={form.price} onChange={e=>set('price',e.target.value)}/></div>
